...
import org.hydrate.apps.entity.TaskStatus;
...
//        System.out.printf("%s\n", saved23.id().toString());
        ...
        Task task31 = new Task(null, task1Name + "3", new TaskStatus(true, LocalDateTime.now()), task1Date, null, null, emptyList());
        Task task32 = new Task(null, task2Name + "3", new TaskStatus(true, LocalDateTime.now()), task2Date, null, task31, emptyList());
        Task task33 = new Task(null, task3Name + "3", new TaskStatus(true, LocalDateTime.now()), task3Date, null, task32, emptyList());
        ...
        Task task41 = new Task(null, task1Name + "4", new TaskStatus(true, LocalDateTime.now()), task1Date,
                new Task(null, task2Name + "4", new TaskStatus(true, LocalDateTime.now()), task2Date,
                        new Task(null, task3Name + "4", new TaskStatus(true, LocalDateTime.now()), task3Date, null, null, emptyList()), null, emptyList()), null, emptyList());
